...
pub struct VillagerBundle {
    ...
    pub behavior_open_door: super::super::components::BehaviorOpenDoor,
    ...
    pub behavior_restrict_open_door: super::super::components::BehaviorRestrictOpenDoor,
...
pub fn spawn_villager(commands: &mut Commands) -> Entity {
    commands
        .spawn(VillagerBundle {
            ...
            behavior_open_door: super::super::components::BehaviorOpenDoor {
                close_door_after: Some(true),
                priority: Some(BehaviorOpenDoorPriority {}),
            },
            ...
            behavior_restrict_open_door: super::super::components::BehaviorRestrictOpenDoor {
                priority: Some(BehaviorRestrictOpenDoorPriority {
                }),
            },
            ...
            damage_sensor: super::super::components::DamageSensor {
                triggers: Some(
                    vec![
                        ...
                        DamageSensorTriggers { cause : None, damage_modifier : None,
                        damage_multiplier : None, deals_damage : None, on_damage :
                        Some(crate
                        ::types::BedrockValue::Object(std::collections::HashMap::from([("event"
