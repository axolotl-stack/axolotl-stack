...
/// Entity definition for `minecraft:cow`
pub struct Cow;
impl Cow {
    /// The entity identifier
    pub const IDENTIFIER: &'static str = "minecraft:cow";
    /// Whether this entity can spawn naturally
    pub const IS_SPAWNABLE: bool = true;
    /// Whether this entity can be summoned via commands
    pub const IS_SUMMONABLE: bool = true;
}
/// Component bundle for spawning a `minecraft:cow`
#[derive(Bundle, Clone)]
...
/// Spawn a new `minecraft:cow` entity with default Bedrock components
pub fn spawn_cow(commands: &mut Commands) -> Entity {
    commands
        .spawn(CowBundle {
            ...
            type_family: super::super::components::TypeFamily {
                family: vec!["cow".to_string(), "mob".to_string()],
            },
        })
        .id()
}
