...
pub struct PillagerBundle {
    ...
    pub behavior_charge_held_item: super::super::components::BehaviorChargeHeldItem,
...
pub fn spawn_pillager(commands: &mut Commands) -> Entity {
    commands
        .spawn(PillagerBundle {
            ...
            behavior_charge_held_item: super::super::components::BehaviorChargeHeldItem {
                items: Some(
                    vec![
                        crate ::types::BedrockValue::String("minecraft:arrow"
                        .to_string())
                    ],
                ),
                priority: Some(BehaviorChargeHeldItemPriority {}),
            },
            ...
            behavior_nearest_attackable_target: super::super::components::BehaviorNearestAttackableTarget {
                ...
                entity_types: Some(
                    vec![
                        ...
                        ::types::BedrockValue::String("is_family".to_string())), ("value"
                        .to_string(), crate
                        ::types::BedrockValue::String("wandering_trader"
            ...
            equipment: super::super::components::Equipment {
                ...
                table: Some("loot_tables/entities/pillager_gear.json".to_string()),
            },
            ...
            type_family: super::super::components::TypeFamily {
                family: vec![
                    "pillager".to_string(), "monster".to_string(), "illager".to_string(),
                    "mob".to_string()
                ],
            },
