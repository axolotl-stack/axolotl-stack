    ...
    commands
        .spawn(HorseBundle {
            ...
            equippable: super::super::components::Equippable {
                slots: Some(
                    vec![
                        EquippableSlots { accepted_items : Some(vec![crate
                        ::types::BedrockValue::String("saddle".to_string())]),
                        interact_text : None, item : Some(crate
                        ::types::BedrockValue::String("saddle".to_string())), on_equip :
                        Some(EquippableSlotsOnEquip { event :
                        Some("minecraft:horse_saddled".to_string()), filters : None,
                        target : None }), on_unequip : Some(EquippableSlotsOnUnequip {
                        event : Some("minecraft:horse_unsaddled".to_string()), filters :
                        None, target : None }), slot : Some(0i32) }, EquippableSlots {
                        accepted_items : Some(vec![crate
                        ::types::BedrockValue::String("horsearmorleather".to_string()),
                        crate ::types::BedrockValue::String("horsearmoriron"
                        .to_string()), crate
                        ::types::BedrockValue::String("horsearmorgold".to_string()),
                        crate ::types::BedrockValue::String("horsearmordiamond"
                        .to_string()), crate
                        ::types::BedrockValue::String("minecraft:copper_horse_armor"
                        .to_string()), crate
                        ::types::BedrockValue::String("minecraft:netherite_horse_armor"
                        .to_string())]), interact_text : None, item : Some(crate
                        ::types::BedrockValue::String("horsearmoriron".to_string())),
                        on_equip : None, on_unequip : None, slot : Some(1i32) }
                    ],
                ),
            },
            ...
            type_family: super::super::components::TypeFamily {
                family: vec!["horse".to_string(), "mob".to_string()],
            },
        })
        .id()
}
