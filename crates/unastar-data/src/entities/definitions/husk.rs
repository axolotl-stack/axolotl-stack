    ...
    commands
        .spawn(HuskBundle {
            attack: super::super::components::Attack {
                ...
                effect_duration: Some(crate::types::MolangOr::Value(30i32)),
                ...
                triggers: Some(crate::types::BedrockValue::Array(vec![
                    ...
                    crate::types::BedrockValue::Object(std::collections::HashMap::from([
                        (
                            "event".to_string(),
                            crate::types::BedrockValue::String(
                                "minecraft:on_start_riding_camel_husk".to_string(),
                            ),
                        ),
                        (
                            "filters".to_string(),
                    ...
                    crate::types::BedrockValue::Object(std::collections::HashMap::from([
                        (
                            "event".to_string(),
                            crate::types::BedrockValue::String(
                                "minecraft:on_stop_riding_camel_husk".to_string(),
                            ),
                        ),
                        (
                            "filters".to_string(),
            ...
            equipment: super::super::components::Equipment {
                ...
                table: Some("loot_tables/entities/zombie_equipment.json".to_string()),
            },
            ...
            variant: super::super::components::Variant { value: 2i32 },
        })
        .id()
}
