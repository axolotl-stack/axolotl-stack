    ...
    commands
        .spawn(ChickenBundle {
            ...
            behavior_tempt: super::super::components::BehaviorTempt {
                ...
                items: Some(
                    vec![
                        crate ::types::BedrockValue::String("wheat_seeds".to_string()),
                        crate ::types::BedrockValue::String("beetroot_seeds"
                        .to_string()), crate ::types::BedrockValue::String("melon_seeds"
                        .to_string()), crate
                        ::types::BedrockValue::String("pumpkin_seeds".to_string()), crate
                        ::types::BedrockValue::String("pitcher_pod".to_string()), crate
            ...
            type_family: super::super::components::TypeFamily {
                family: vec!["chicken".to_string(), "mob".to_string()],
            },
        })
        .id()
}
