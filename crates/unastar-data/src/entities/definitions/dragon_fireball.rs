    ...
    commands
        .spawn(DragonFireballBundle {
            ...
            projectile: super::super::components::Projectile {
                ...
                hit_sound: Some("explode".to_string()),
                homing: Some(false),
                ...
                on_hit: Some(ProjectileOnHit {
                    ...
                    spawn_aoe_cloud: Some(ProjectileOnHitSpawnAoeCloud {
                        affect_owner: Some(false),
                        color: None,
                        duration: Some(120i32),
                        particle: Some("dragonbreath".to_string()),
                        potion: Some(23i32),
                        radius: Some(6f32),
                        radius_on_use: Some(0f32),
                        reapplication_delay: Some(20i32),
                    }),
                    spawn_chance: None,
                ...
                semi_random_diff_damage: Some(true),
                shoot_sound: None,
