    ...
    commands
        .spawn(PigBundle {
            ...
            behavior_tempt: super::super::components::BehaviorTempt {
                ...
                items: Some(
                    vec![
                        crate ::types::BedrockValue::String("potato".to_string()), crate
                        ::types::BedrockValue::String("carrot".to_string()), crate
                        ::types::BedrockValue::String("beetroot".to_string()), crate
                        ::types::BedrockValue::String("carrotOnAStick".to_string())
                    ],
                ),
                on_end: None,
                on_start: None,
            ...
            type_family: super::super::components::TypeFamily {
                family: vec!["pig".to_string(), "mob".to_string()],
            },
        })
        .id()
}
