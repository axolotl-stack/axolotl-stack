...
pub fn spawn_camel(commands: &mut Commands) -> Entity {
    commands
        .spawn(CamelBundle {
            ...
            behavior_random_look_around_and_sit: super::super::components::BehaviorRandomLookAroundAndSit {
            ...
            behavior_tempt: super::super::components::BehaviorTempt {
                ...
                items: Some(
                    vec![crate ::types::BedrockValue::String("cactus".to_string())],
                ),
                on_end: None,
                on_start: None,
            ...
            damage_sensor: super::super::components::DamageSensor {
                triggers: Some(
                    vec![
                        ...
                        damage_modifier : Some(- 4f32), damage_multiplier : None,
            ...
            healable: super::super::components::Healable {
                ...
                items: Some(
                    vec![
                        ...
                        ::types::BedrockValue::String("cactus".to_string())), result_item
                        : None }
                    ],
                ),
            },
            ...
            type_family: super::super::components::TypeFamily {
                family: vec!["camel".to_string(), "mob".to_string()],
            },
