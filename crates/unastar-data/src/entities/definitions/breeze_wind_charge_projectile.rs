    ...
    commands
        .spawn(BreezeWindChargeProjectileBundle {
            ...
            explode: super::super::components::Explode {
                ...
                fuse_length: None,
                fuse_lit: Some(false),
                knockback_scaling: Some(0.6f32),
                max_resistance: Some(0f32),
                negates_fall_damage: Some(false),
                particle_effect: Some("breeze_wind_burst".to_string()),
                power: Some(3f32),
                sound_effect: Some("breeze_wind_charge.burst".to_string()),
