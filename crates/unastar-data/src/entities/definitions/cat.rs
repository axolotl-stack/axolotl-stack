    ...
    commands
        .spawn(CatBundle {
            ...
            dweller: super::super::components::Dweller {
                can_find_poi: Some(false),
                can_migrate: Some(true),
                dweller_role: Some("passive".to_string()),
                dwelling_bounds_tolerance: None,
                dwelling_type: Some("village".to_string()),
                first_founding_reward: Some(0i32),
            ...
            healable: super::super::components::Healable {
                ...
                items: Some(
                    vec![
                        ...
                        ::types::BedrockValue::String("fish".to_string())), result_item :
                        None }, HealableItems { effects : None, filters : None,
                        heal_amount : Some(2i32), item : Some(crate
                        ::types::BedrockValue::String("salmon".to_string())), result_item
                        : None }
                    ],
                ),
            },
            ...
            type_family: super::super::components::TypeFamily {
                family: vec!["cat".to_string(), "mob".to_string()],
            },
        })
        .id()
}
