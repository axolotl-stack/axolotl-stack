...
pub fn get(identifier: &str) -> Option<&'static EntityDefinitionData> {
    match identifier {
        "minecraft:allay" => Some(&ALL_ENTITIES[0]),
        "minecraft:area_effect_cloud" => Some(&ALL_ENTITIES[1]),
        "minecraft:armadillo" => Some(&ALL_ENTITIES[2]),
        "minecraft:armor_stand" => Some(&ALL_ENTITIES[3]),
        "minecraft:arrow" => Some(&ALL_ENTITIES[4]),
        "minecraft:axolotl" => Some(&ALL_ENTITIES[5]),
        "minecraft:bat" => Some(&ALL_ENTITIES[6]),
        "minecraft:bee" => Some(&ALL_ENTITIES[7]),
        "minecraft:blaze" => Some(&ALL_ENTITIES[8]),
        "minecraft:boat" => Some(&ALL_ENTITIES[9]),
        "minecraft:bogged" => Some(&ALL_ENTITIES[10]),
        "minecraft:breeze" => Some(&ALL_ENTITIES[11]),
        "minecraft:breeze_wind_charge_projectile" => Some(&ALL_ENTITIES[12]),
        "minecraft:camel" => Some(&ALL_ENTITIES[13]),
        "minecraft:camel_husk" => Some(&ALL_ENTITIES[14]),
        "minecraft:cat" => Some(&ALL_ENTITIES[15]),
        "minecraft:cave_spider" => Some(&ALL_ENTITIES[16]),
        "minecraft:chest_boat" => Some(&ALL_ENTITIES[17]),
        "minecraft:chest_minecart" => Some(&ALL_ENTITIES[18]),
        "minecraft:chicken" => Some(&ALL_ENTITIES[19]),
        "minecraft:cod" => Some(&ALL_ENTITIES[20]),
        "minecraft:command_block_minecart" => Some(&ALL_ENTITIES[21]),
        "minecraft:copper_golem" => Some(&ALL_ENTITIES[22]),
        "minecraft:cow" => Some(&ALL_ENTITIES[23]),
        "minecraft:creaking" => Some(&ALL_ENTITIES[24]),
        "minecraft:creeper" => Some(&ALL_ENTITIES[25]),
        "minecraft:dolphin" => Some(&ALL_ENTITIES[26]),
        "minecraft:donkey" => Some(&ALL_ENTITIES[27]),
        "minecraft:dragon_fireball" => Some(&ALL_ENTITIES[28]),
        "minecraft:drowned" => Some(&ALL_ENTITIES[29]),
        "minecraft:egg" => Some(&ALL_ENTITIES[30]),
        "minecraft:elder_guardian" => Some(&ALL_ENTITIES[31]),
        "minecraft:ender_crystal" => Some(&ALL_ENTITIES[32]),
        "minecraft:ender_dragon" => Some(&ALL_ENTITIES[33]),
        "minecraft:ender_pearl" => Some(&ALL_ENTITIES[34]),
        "minecraft:enderman" => Some(&ALL_ENTITIES[35]),
        "minecraft:endermite" => Some(&ALL_ENTITIES[36]),
        "minecraft:evocation_illager" => Some(&ALL_ENTITIES[37]),
        "minecraft:eye_of_ender_signal" => Some(&ALL_ENTITIES[38]),
        "minecraft:fireball" => Some(&ALL_ENTITIES[39]),
        "minecraft:fireworks_rocket" => Some(&ALL_ENTITIES[40]),
        "minecraft:fishing_hook" => Some(&ALL_ENTITIES[41]),
        "minecraft:fox" => Some(&ALL_ENTITIES[42]),
        "minecraft:frog" => Some(&ALL_ENTITIES[43]),
        "minecraft:ghast" => Some(&ALL_ENTITIES[44]),
        "minecraft:glow_squid" => Some(&ALL_ENTITIES[45]),
        "minecraft:goat" => Some(&ALL_ENTITIES[46]),
        "minecraft:guardian" => Some(&ALL_ENTITIES[47]),
        "minecraft:happy_ghast" => Some(&ALL_ENTITIES[48]),
        "minecraft:hoglin" => Some(&ALL_ENTITIES[49]),
        "minecraft:hopper_minecart" => Some(&ALL_ENTITIES[50]),
        "minecraft:horse" => Some(&ALL_ENTITIES[51]),
        "minecraft:husk" => Some(&ALL_ENTITIES[52]),
        "minecraft:iron_golem" => Some(&ALL_ENTITIES[53]),
        "minecraft:lightning_bolt" => Some(&ALL_ENTITIES[54]),
        "minecraft:lingering_potion" => Some(&ALL_ENTITIES[55]),
        "minecraft:llama" => Some(&ALL_ENTITIES[56]),
        "minecraft:llama_spit" => Some(&ALL_ENTITIES[57]),
        "minecraft:magma_cube" => Some(&ALL_ENTITIES[58]),
        "minecraft:minecart" => Some(&ALL_ENTITIES[59]),
        "minecraft:mooshroom" => Some(&ALL_ENTITIES[60]),
        "minecraft:mule" => Some(&ALL_ENTITIES[61]),
        "minecraft:nautilus" => Some(&ALL_ENTITIES[62]),
        "minecraft:npc" => Some(&ALL_ENTITIES[63]),
        "minecraft:ocelot" => Some(&ALL_ENTITIES[64]),
        "minecraft:ominous_item_spawner" => Some(&ALL_ENTITIES[65]),
        "minecraft:panda" => Some(&ALL_ENTITIES[66]),
        "minecraft:parched" => Some(&ALL_ENTITIES[67]),
        "minecraft:parrot" => Some(&ALL_ENTITIES[68]),
        "minecraft:phantom" => Some(&ALL_ENTITIES[69]),
        "minecraft:pig" => Some(&ALL_ENTITIES[70]),
        "minecraft:piglin" => Some(&ALL_ENTITIES[71]),
        "minecraft:piglin_brute" => Some(&ALL_ENTITIES[72]),
        "minecraft:pillager" => Some(&ALL_ENTITIES[73]),
        "minecraft:player" => Some(&ALL_ENTITIES[74]),
        "minecraft:polar_bear" => Some(&ALL_ENTITIES[75]),
        "minecraft:pufferfish" => Some(&ALL_ENTITIES[76]),
        "minecraft:rabbit" => Some(&ALL_ENTITIES[77]),
        "minecraft:ravager" => Some(&ALL_ENTITIES[78]),
        "minecraft:salmon" => Some(&ALL_ENTITIES[79]),
        "minecraft:sheep" => Some(&ALL_ENTITIES[80]),
        "minecraft:shulker" => Some(&ALL_ENTITIES[81]),
        "minecraft:shulker_bullet" => Some(&ALL_ENTITIES[82]),
        "minecraft:silverfish" => Some(&ALL_ENTITIES[83]),
        "minecraft:skeleton" => Some(&ALL_ENTITIES[84]),
        "minecraft:skeleton_horse" => Some(&ALL_ENTITIES[85]),
        "minecraft:slime" => Some(&ALL_ENTITIES[86]),
        "minecraft:small_fireball" => Some(&ALL_ENTITIES[87]),
        "minecraft:sniffer" => Some(&ALL_ENTITIES[88]),
        "minecraft:snow_golem" => Some(&ALL_ENTITIES[89]),
        "minecraft:snowball" => Some(&ALL_ENTITIES[90]),
        "minecraft:spider" => Some(&ALL_ENTITIES[91]),
        "minecraft:splash_potion" => Some(&ALL_ENTITIES[92]),
        "minecraft:squid" => Some(&ALL_ENTITIES[93]),
        "minecraft:stray" => Some(&ALL_ENTITIES[94]),
        "minecraft:strider" => Some(&ALL_ENTITIES[95]),
        "minecraft:tadpole" => Some(&ALL_ENTITIES[96]),
        "minecraft:thrown_trident" => Some(&ALL_ENTITIES[97]),
        "minecraft:tnt" => Some(&ALL_ENTITIES[98]),
        "minecraft:tnt_minecart" => Some(&ALL_ENTITIES[99]),
        "minecraft:trader_llama" => Some(&ALL_ENTITIES[100]),
        "minecraft:tripod_camera" => Some(&ALL_ENTITIES[101]),
        "minecraft:tropicalfish" => Some(&ALL_ENTITIES[102]),
        "minecraft:turtle" => Some(&ALL_ENTITIES[103]),
        "minecraft:vex" => Some(&ALL_ENTITIES[104]),
        "minecraft:villager" => Some(&ALL_ENTITIES[105]),
        "minecraft:villager_v2" => Some(&ALL_ENTITIES[106]),
        "minecraft:vindicator" => Some(&ALL_ENTITIES[107]),
        "minecraft:wandering_trader" => Some(&ALL_ENTITIES[108]),
        "minecraft:warden" => Some(&ALL_ENTITIES[109]),
        "minecraft:wind_charge_projectile" => Some(&ALL_ENTITIES[110]),
        "minecraft:witch" => Some(&ALL_ENTITIES[111]),
        "minecraft:wither" => Some(&ALL_ENTITIES[112]),
        "minecraft:wither_skeleton" => Some(&ALL_ENTITIES[113]),
        "minecraft:wither_skull" => Some(&ALL_ENTITIES[114]),
        "minecraft:wither_skull_dangerous" => Some(&ALL_ENTITIES[115]),
        "minecraft:wolf" => Some(&ALL_ENTITIES[116]),
        "minecraft:xp_bottle" => Some(&ALL_ENTITIES[117]),
        "minecraft:xp_orb" => Some(&ALL_ENTITIES[118]),
        "minecraft:zoglin" => Some(&ALL_ENTITIES[119]),
        "minecraft:zombie" => Some(&ALL_ENTITIES[120]),
        "minecraft:zombie_horse" => Some(&ALL_ENTITIES[121]),
        "minecraft:zombie_nautilus" => Some(&ALL_ENTITIES[122]),
        "minecraft:zombie_pigman" => Some(&ALL_ENTITIES[123]),
        "minecraft:zombie_villager" => Some(&ALL_ENTITIES[124]),
        "minecraft:zombie_villager_v2" => Some(&ALL_ENTITIES[125]),
        _ => None,
    }
}
