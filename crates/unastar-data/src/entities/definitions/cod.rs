    ...
    commands
        .spawn(CodBundle {
            ...
            flocking: super::super::components::Flocking {
                block_distance: Some(2f32),
                block_weight: Some(0.85f32),
                breach_influence: Some(7f32),
                cohesion_threshold: Some(1.95f32),
                cohesion_weight: Some(2f32),
                goal_weight: Some(2f32),
                high_flock_limit: Some(8i32),
                in_water: Some(true),
                influence_radius: Some(3f32),
                innner_cohesion_threshold: Some(1.25f32),
                loner_chance: Some(0.1f32),
                low_flock_limit: Some(4i32),
                match_variants: Some(false),
                max_height: Some(6f32),
                min_height: Some(1.5f32),
                separation_threshold: Some(0.95f32),
                separation_weight: Some(1.75f32),
                use_center_of_mass: Some(true),
            },
            ...
            scale: super::super::components::Scale { value: 1f32 },
            type_family: super::super::components::TypeFamily {
                family: vec!["aquatic".to_string(), "cod".to_string(), "fish".to_string()],
            },
