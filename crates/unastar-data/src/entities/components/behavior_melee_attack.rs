...
pub struct BehaviorMeleeAttackControlFlags {}
impl Default for BehaviorMeleeAttackControlFlags {
    fn default() -> Self {
        Self {}
    }
}
#[derive(Debug, Clone, PartialEq)]
pub struct BehaviorMeleeAttackPriority {}
impl Default for BehaviorMeleeAttackPriority {
    fn default() -> Self {
        Self {}
    }
}
#[derive(Debug, Clone, PartialEq)]
pub struct BehaviorMeleeAttackSpeedMultiplier {}
impl Default for BehaviorMeleeAttackSpeedMultiplier {
    fn default() -> Self {
        Self {}
    }
}
/// Bedrock component `minecraft:behavior.melee_attack`. Allows the mob to use close combat melee attacks.
...
pub struct BehaviorMeleeAttack {
    ...
    ///control_flags
    pub control_flags: Option<BehaviorMeleeAttackControlFlags>,
    ...
    ///priority
    pub priority: Option<BehaviorMeleeAttackPriority>,
    ...
    ///speed_multiplier
    pub speed_multiplier: Option<BehaviorMeleeAttackSpeedMultiplier>,
    ///Unused. No effect on "minecraft:behavior.melee_attack".
...
impl Default for BehaviorMeleeAttack {
    fn default() -> Self {
        Self {
