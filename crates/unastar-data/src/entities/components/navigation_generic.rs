...
/// Bedrock component `minecraft:navigation.generic`. Allows this entity to generate paths by walking, swimming, flying and/or climbing around and jumping up and down a block.
...
impl Default for NavigationGeneric {
    fn default() -> Self {
        Self {
