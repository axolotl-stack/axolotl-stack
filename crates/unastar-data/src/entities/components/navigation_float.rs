...
/// Bedrock component `minecraft:navigation.float`. Allows this entity to generate paths by flying around the air like the regular Ghast.
...
impl Default for NavigationFloat {
    fn default() -> Self {
        Self {
