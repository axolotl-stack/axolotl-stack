...
/// Bedrock component `minecraft:underwater_movement`. Specifies the initial value of a specific attribute for an entity when spawned.
...
impl Default for UnderwaterMovement {
    fn default() -> Self {
        Self {
            max: None,
            min: None,
