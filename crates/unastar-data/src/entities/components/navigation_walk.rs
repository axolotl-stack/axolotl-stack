...
/// Bedrock component `minecraft:navigation.walk`. Allows this entity to generate paths by walking around and jumping up and down a block like regular mobs.
...
impl Default for NavigationWalk {
    fn default() -> Self {
        Self {
