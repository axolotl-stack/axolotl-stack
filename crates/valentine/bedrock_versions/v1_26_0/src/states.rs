...
/// State shared by: ["purpur_double_slab", "petrified_oak_slab", "waxed_exposed_cut_copper_slab", "smooth_sandstone_slab", "cut_red_sandstone_double_slab"]
/// ... and 119 more blocks
...
/// State shared by: ["stripped_warped_hyphae", "quartz_block", "muddy_mangrove_roots", "spruce_log", "jungle_log"]
/// ... and 66 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["prismarine_bricks_stairs", "polished_granite_stairs", "normal_stone_stairs", "crimson_stairs", "mangrove_stairs"]
/// ... and 53 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["wall_banner", "bamboo_wall_sign", "gray_glazed_terracotta", "end_rod", "warped_wall_sign"]
/// ... and 37 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["oxidized_copper_golem_statue", "waxed_oxidized_copper_chest", "deprecated_anvil", "waxed_weathered_copper_chest", "waxed_exposed_copper_golem_statue"]
/// ... and 28 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["deepslate_tile_wall", "red_nether_brick_wall", "prismarine_wall", "stone_brick_wall", "mossy_stone_brick_wall"]
/// ... and 22 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["iron_door", "jungle_door", "birch_door", "waxed_oxidized_copper_door", "weathered_copper_door"]
/// ... and 16 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["oxidized_copper_trapdoor", "waxed_exposed_copper_trapdoor", "jungle_trapdoor", "waxed_oxidized_copper_trapdoor", "mangrove_trapdoor"]
/// ... and 16 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["spruce_pressure_plate", "mangrove_pressure_plate", "daylight_detector", "redstone_wire", "pale_oak_pressure_plate"]
/// ... and 14 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["pink_candle_cake", "green_candle_cake", "lime_candle_cake", "candle_cake", "magenta_candle_cake"]
/// ... and 12 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["green_candle", "white_candle", "lime_candle", "cyan_candle", "purple_candle"]
/// ... and 12 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["wooden_button", "warped_button", "bamboo_button", "pale_oak_button", "acacia_button"]
/// ... and 9 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["standing_banner", "pale_oak_standing_sign", "birch_standing_sign", "acacia_standing_sign", "cherry_standing_sign"]
/// ... and 8 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["dark_oak_fence_gate", "birch_fence_gate", "acacia_fence_gate", "cherry_fence_gate", "bamboo_fence_gate"]
/// ... and 7 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["cherry_hanging_sign", "jungle_hanging_sign", "warped_hanging_sign", "crimson_hanging_sign", "mangrove_hanging_sign"]
/// ... and 7 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["cherry_shelf", "acacia_shelf", "oak_shelf", "crimson_shelf", "warped_shelf"]
/// ... and 7 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["oak_leaves", "spruce_leaves", "dark_oak_leaves", "jungle_leaves", "cherry_leaves"]
/// ... and 6 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["dead_horn_coral_fan", "tube_coral_fan", "dead_bubble_coral_fan", "fire_coral_fan", "brain_coral_fan"]
/// ... and 5 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["colored_torch_blue", "copper_torch", "torch", "soul_torch", "unlit_redstone_torch"]
/// ... and 5 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["dead_brain_coral_wall_fan", "bubble_coral_wall_fan", "dead_tube_coral_wall_fan", "fire_coral_wall_fan", "dead_horn_coral_wall_fan"]
/// ... and 5 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["waxed_weathered_copper_lantern", "waxed_oxidized_copper_lantern", "oxidized_copper_lantern", "waxed_copper_lantern", "copper_lantern"]
/// ... and 5 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["birch_sapling", "dark_oak_sapling", "pale_oak_sapling", "acacia_sapling", "cherry_sapling"]
/// ... and 4 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["lightning_rod", "waxed_oxidized_lightning_rod", "waxed_weathered_lightning_rod", "oxidized_lightning_rod", "weathered_lightning_rod"]
/// ... and 3 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["exposed_copper_bulb", "weathered_copper_bulb", "oxidized_copper_bulb", "waxed_oxidized_copper_bulb", "waxed_weathered_copper_bulb"]
/// ... and 3 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["lilac", "peony", "sunflower", "large_fern", "pitcher_plant"]
/// ... and 2 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["sweet_berry_bush", "carrots", "potatoes", "beetroot", "torchflower_crop"]
/// ... and 1 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["loom", "lab_table", "decorated_pot", "compound_creator", "element_constructor"]
/// ... and 1 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["medium_amethyst_bud", "small_amethyst_bud", "amethyst_cluster", "large_amethyst_bud"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["lava", "flowing_lava", "water", "flowing_water"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["cactus", "fire", "reeds", "soul_fire"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub struct AgeState {
    age: u8,
}
...
/// State shared by: ["command_block", "repeating_command_block", "chain_command_block"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["mushroom_stem", "brown_mushroom_block", "red_mushroom_block"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
