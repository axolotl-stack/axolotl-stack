...
fn read_string<B: bytes::Buf>(buf: &mut B) -> Result<String, crate::bedrock::error::DecodeError> {
    let len_raw =
        <crate::bedrock::codec::VarInt as crate::bedrock::codec::BedrockCodec>::decode(buf, ())?.0
            as i64;
    if len_raw < 0 {
        return Err(crate::bedrock::error::DecodeError::NegativeLength { value: len_raw });
    }
...
impl crate::bedrock::codec::BedrockCodec for TextPacket {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        let category: u8 = match self.type_ {
            ...
            | TextPacketType::Json => 0, // MessageOnly
...
impl<'a> From<&'a crate::bedrock::context::BedrockSession> for MobArmorEquipmentPacketArgs {
    fn from(source: &'a crate::bedrock::context::BedrockSession) -> Self {
        Self {
            shield_item_id: source.shield_item_id,
        }
...
impl<'a> From<&'a crate::bedrock::context::BedrockSession> for InventoryContentPacketArgs {
    fn from(source: &'a crate::bedrock::context::BedrockSession) -> Self {
        Self {
            shield_item_id: source.shield_item_id,
        }
...
impl crate::bedrock::codec::BedrockCodec for DebugRendererPacket {
    ...
    fn decode<B: bytes::Buf>(
        ...
        let data = if has_data {
            Some(Box::new(
                <DebugMarkerData as crate::bedrock::codec::BedrockCodec>::decode(buf, ())?,
            ))
        } else {
            None
        };
