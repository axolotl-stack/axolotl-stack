...
impl Default for PacketServerboundPackSettingChangePackSettingType {
    fn default() -> Self {
        Self::Float
    }
}
...
impl Default for PacketServerboundPackSettingChangePackSettingValue {
    fn default() -> Self {
...
impl Default for PacketServerboundDataStoreDataType {
    fn default() -> Self {
        Self::Double
    }
}
...
impl Default for PacketServerboundDataStoreData {
    fn default() -> Self {
        Self::Bool(Default::default())
    }
}
