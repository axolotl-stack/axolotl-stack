...
impl PotentSulfurState {
    ...
    pub fn from_raw(v: u8) -> Option<Self> {
        match v {
            ...
            1 => Some(Self::Wet),
            2 => Some(Self::Dormant),
            3 => Some(Self::Erupting),
            4 => Some(Self::Continuous),
            _ => None,
        }
    }
}
...
/// State shared by: ["waxed_weathered_cut_copper_slab", "nether_brick_double_slab", "mud_brick_slab", "polished_sulfur_slab", "bamboo_mosaic_slab"]
/// ... and 131 more blocks
...
/// State shared by: ["acacia_wood", "basalt", "purpur_pillar", "bamboo_block", "polished_basalt"]
/// ... and 66 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["bamboo_mosaic_stairs", "tuff_stairs", "crimson_stairs", "warped_stairs", "smooth_quartz_stairs"]
/// ... and 59 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["piston_arm_collision", "magenta_glazed_terracotta", "warped_wall_sign", "purple_glazed_terracotta", "yellow_glazed_terracotta"]
/// ... and 37 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["waxed_exposed_copper_golem_statue", "lit_smoker", "smoker", "waxed_oxidized_copper_chest", "lit_furnace"]
/// ... and 28 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["polished_sulfur_wall", "granite_wall", "andesite_wall", "brick_wall", "polished_blackstone_brick_wall"]
/// ... and 28 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["jungle_door", "pale_oak_door", "weathered_copper_door", "wooden_door", "iron_door"]
/// ... and 16 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["waxed_exposed_copper_trapdoor", "waxed_copper_trapdoor", "mangrove_trapdoor", "iron_trapdoor", "acacia_trapdoor"]
/// ... and 16 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["mangrove_pressure_plate", "daylight_detector", "cherry_pressure_plate", "heavy_weighted_pressure_plate", "acacia_pressure_plate"]
/// ... and 14 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["orange_candle", "light_blue_candle", "magenta_candle", "blue_candle", "pink_candle"]
/// ... and 12 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["lime_candle_cake", "white_candle_cake", "blue_candle_cake", "red_candle_cake", "light_gray_candle_cake"]
/// ... and 12 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["dark_oak_button", "acacia_button", "polished_blackstone_button", "stone_button", "mangrove_button"]
/// ... and 9 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["standing_sign", "darkoak_standing_sign", "birch_standing_sign", "jungle_standing_sign", "standing_banner"]
/// ... and 8 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["warped_fence_gate", "jungle_fence_gate", "birch_fence_gate", "acacia_fence_gate", "bamboo_fence_gate"]
/// ... and 7 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["bamboo_shelf", "spruce_shelf", "oak_shelf", "warped_shelf", "acacia_shelf"]
/// ... and 7 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["dark_oak_hanging_sign", "bamboo_hanging_sign", "birch_hanging_sign", "warped_hanging_sign", "cherry_hanging_sign"]
/// ... and 7 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["birch_leaves", "dark_oak_leaves", "mangrove_leaves", "azalea_leaves", "spruce_leaves"]
/// ... and 6 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["oxidized_copper_lantern", "lantern", "waxed_oxidized_copper_lantern", "exposed_copper_lantern", "copper_lantern"]
/// ... and 5 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["dead_bubble_coral_wall_fan", "dead_brain_coral_wall_fan", "tube_coral_wall_fan", "fire_coral_wall_fan", "bubble_coral_wall_fan"]
/// ... and 5 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["horn_coral_fan", "dead_brain_coral_fan", "dead_tube_coral_fan", "brain_coral_fan", "fire_coral_fan"]
/// ... and 5 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["colored_torch_blue", "soul_torch", "unlit_redstone_torch", "colored_torch_green", "underwater_torch"]
/// ... and 5 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["birch_sapling", "jungle_sapling", "cherry_sapling", "acacia_sapling", "oak_sapling"]
/// ... and 4 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["copper_bulb", "waxed_oxidized_copper_bulb", "waxed_exposed_copper_bulb", "oxidized_copper_bulb", "waxed_weathered_copper_bulb"]
/// ... and 3 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["waxed_oxidized_lightning_rod", "oxidized_lightning_rod", "waxed_lightning_rod", "exposed_lightning_rod", "waxed_exposed_lightning_rod"]
/// ... and 3 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["tall_grass", "pitcher_plant", "peony", "rose_bush", "sunflower"]
/// ... and 2 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["loom", "decorated_pot", "element_constructor", "lab_table", "material_reducer"]
/// ... and 1 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["wheat", "sweet_berry_bush", "beetroot", "torchflower_crop", "carrots"]
/// ... and 1 more blocks
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["amethyst_cluster", "large_amethyst_bud", "medium_amethyst_bud", "small_amethyst_bud"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["fire", "reeds", "soul_fire", "cactus"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub struct AgeState {
    age: u8,
}
...
/// State shared by: ["water", "lava", "flowing_lava", "flowing_water"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["pink_petals", "wildflowers", "leaf_litter"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["cave_vines_head_with_berries", "cave_vines_body_with_berries", "cave_vines"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["glow_lichen", "sculk_vein", "resin_clump"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["hay_block", "bone_block"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["powered_repeater", "unpowered_repeater"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["dropper", "dispenser"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
/// State shared by: ["sulfur_spike", "pointed_dripstone"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub struct State2Props {
...
impl BlockState for State2Props {
    fn state_offset(&self) -> u32 {
        let mut offset = 0u32;
        let mut multiplier = 1u32;
...
/// State shared by: ["potent_sulfur"]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub struct PotentSulfurBlockState {
    potent_sulfur_state: PotentSulfurState,
}

impl PotentSulfurBlockState {
    /// Create a new state with validation.
    pub fn new(potent_sulfur_state: PotentSulfurState) -> Result<Self, valentine_bedrock_core::block::StateError> {
        Ok(Self { potent_sulfur_state })
    }

    /// Get the potent_sulfur_state value.
    #[inline]
    pub fn potent_sulfur_state(&self) -> PotentSulfurState { self.potent_sulfur_state }
}

impl BlockState for PotentSulfurBlockState {
    fn state_offset(&self) -> u32 {
        let mut offset = 0u32;
        let multiplier = 1u32;
        offset += (self.potent_sulfur_state as u32) * multiplier;
        offset
    }
    ...
    fn from_offset(offset: u32) -> Option<Self> {
        if offset >= 5 { return None; }
        let rem = offset;
        let potent_sulfur_state = PotentSulfurState::from_raw((rem % 5) as u8)?;
        Some(Self { potent_sulfur_state })
    }
