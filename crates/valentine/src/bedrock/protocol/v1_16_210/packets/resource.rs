...
impl crate::bedrock::codec::BedrockCodec for PacketResourcePackDataInfo {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::U64LE(self.compressed_package_size).encode(buf)?;
    ...
    fn decode<B: bytes::Buf>(
        ...
        let chunk_count = <crate::bedrock::codec::U32LE as crate::bedrock::codec::BedrockCodec>::decode(
            ...
            .0;
        let compressed_package_size = <crate::bedrock::codec::U64LE as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0;
