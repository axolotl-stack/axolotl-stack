...
impl crate::bedrock::codec::BedrockCodec for PacketDebugRenderer {
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        if let Some(v) = &self.content {
            match v {
                PacketDebugRendererContent::AddCube(v) => v.encode(buf)?,
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        let content = match type_ {
            ...
            _ => Some(PacketDebugRendererContent::Clear),
            _ => None,
        };
...
impl crate::bedrock::codec::BedrockCodec for PacketInteract {
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        self.target_entity_id.encode(buf)?;
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        let target_entity_id = <i64 as crate::bedrock::codec::BedrockCodec>::decode(
            buf,
        )?;
