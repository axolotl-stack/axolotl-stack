...
impl From<PacketServerPostMove> for McpePacket {
    fn from(packet: PacketServerPostMove) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl GamePacket for PacketItemRegistry {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketItemRegistry;
}
impl From<PacketItemRegistry> for McpePacketData {
    fn from(packet: PacketItemRegistry) -> Self {
        McpePacketData::PacketItemRegistry(packet)
    }
}
impl From<PacketItemRegistry> for McpePacket {
    fn from(packet: PacketItemRegistry) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketUpdateClientInputLocks> for McpePacket {
    fn from(packet: PacketUpdateClientInputLocks) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketClientCheatAbility> for McpePacket {
    fn from(packet: PacketClientCheatAbility) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketCameraPresets> for McpePacket {
    fn from(packet: PacketCameraPresets) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketUnlockedRecipes> for McpePacket {
    fn from(packet: PacketUnlockedRecipes) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketCameraInstruction> for McpePacket {
    fn from(packet: PacketCameraInstruction) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketCompressedBiomeDefinitions> for McpePacket {
    fn from(packet: PacketCompressedBiomeDefinitions) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketTrimData> for McpePacket {
    fn from(packet: PacketTrimData) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketOpenSign> for McpePacket {
    fn from(packet: PacketOpenSign) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketAgentAnimation> for McpePacket {
    fn from(packet: PacketAgentAnimation) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketRefreshEntitlements> for McpePacket {
    fn from(packet: PacketRefreshEntitlements) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketToggleCrafterSlotRequest> for McpePacket {
    fn from(packet: PacketToggleCrafterSlotRequest) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketSetPlayerInventoryOptions> for McpePacket {
    fn from(packet: PacketSetPlayerInventoryOptions) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketSetHud> for McpePacket {
    fn from(packet: PacketSetHud) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketAwardAchievement> for McpePacket {
    fn from(packet: PacketAwardAchievement) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketClientboundCloseForm> for McpePacket {
    fn from(packet: PacketClientboundCloseForm) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketServerboundLoadingScreen> for McpePacket {
    fn from(packet: PacketServerboundLoadingScreen) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketJigsawStructureData> for McpePacket {
    fn from(packet: PacketJigsawStructureData) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketCurrentStructureFeature> for McpePacket {
    fn from(packet: PacketCurrentStructureFeature) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketServerboundDiagnostics> for McpePacket {
    fn from(packet: PacketServerboundDiagnostics) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketCameraAimAssist> for McpePacket {
    fn from(packet: PacketCameraAimAssist) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketContainerRegistryCleanup> for McpePacket {
    fn from(packet: PacketContainerRegistryCleanup) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketMovementEffect> for McpePacket {
    fn from(packet: PacketMovementEffect) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
impl From<PacketSetMovementAuthority> for McpePacket {
    fn from(packet: PacketSetMovementAuthority) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketCameraAimAssistPresets {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketCameraAimAssistPresets;
}
impl From<PacketCameraAimAssistPresets> for McpePacketData {
    fn from(packet: PacketCameraAimAssistPresets) -> Self {
        McpePacketData::PacketCameraAimAssistPresets(packet)
    }
}
impl From<PacketCameraAimAssistPresets> for McpePacket {
    fn from(packet: PacketCameraAimAssistPresets) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketClientCameraAimAssist {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketClientCameraAimAssist;
}
impl From<PacketClientCameraAimAssist> for McpePacketData {
    fn from(packet: PacketClientCameraAimAssist) -> Self {
        McpePacketData::PacketClientCameraAimAssist(packet)
    }
}
impl From<PacketClientCameraAimAssist> for McpePacket {
    fn from(packet: PacketClientCameraAimAssist) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketClientMovementPredictionSync {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketClientMovementPredictionSync;
}
impl From<PacketClientMovementPredictionSync> for McpePacketData {
    fn from(packet: PacketClientMovementPredictionSync) -> Self {
        McpePacketData::PacketClientMovementPredictionSync(Box::new(packet))
    }
}
impl From<PacketClientMovementPredictionSync> for McpePacket {
    fn from(packet: PacketClientMovementPredictionSync) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketUpdateClientOptions {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketUpdateClientOptions;
}
impl From<PacketUpdateClientOptions> for McpePacketData {
    fn from(packet: PacketUpdateClientOptions) -> Self {
        McpePacketData::PacketUpdateClientOptions(packet)
    }
}
impl From<PacketUpdateClientOptions> for McpePacket {
    fn from(packet: PacketUpdateClientOptions) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketPlayerVideoCapture {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketPlayerVideoCapture;
}
impl From<PacketPlayerVideoCapture> for McpePacketData {
    fn from(packet: PacketPlayerVideoCapture) -> Self {
        McpePacketData::PacketPlayerVideoCapture(Box::new(packet))
    }
}
impl From<PacketPlayerVideoCapture> for McpePacket {
    fn from(packet: PacketPlayerVideoCapture) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketPlayerUpdateEntityOverrides {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketPlayerUpdateEntityOverrides;
}
impl From<PacketPlayerUpdateEntityOverrides> for McpePacketData {
    fn from(packet: PacketPlayerUpdateEntityOverrides) -> Self {
        McpePacketData::PacketPlayerUpdateEntityOverrides(Box::new(packet))
    }
}
impl From<PacketPlayerUpdateEntityOverrides> for McpePacket {
    fn from(packet: PacketPlayerUpdateEntityOverrides) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketPlayerLocation {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketPlayerLocation;
}
impl From<PacketPlayerLocation> for McpePacketData {
    fn from(packet: PacketPlayerLocation) -> Self {
        McpePacketData::PacketPlayerLocation(Box::new(packet))
    }
}
impl From<PacketPlayerLocation> for McpePacket {
    fn from(packet: PacketPlayerLocation) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketClientboundControlsScheme {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketClientboundControlsScheme;
}
impl From<PacketClientboundControlsScheme> for McpePacketData {
    fn from(packet: PacketClientboundControlsScheme) -> Self {
        McpePacketData::PacketClientboundControlsScheme(packet)
    }
}
impl From<PacketClientboundControlsScheme> for McpePacket {
    fn from(packet: PacketClientboundControlsScheme) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketServerScriptDebugDrawer {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketServerScriptDebugDrawer;
}
impl From<PacketServerScriptDebugDrawer> for McpePacketData {
    fn from(packet: PacketServerScriptDebugDrawer) -> Self {
        McpePacketData::PacketServerScriptDebugDrawer(packet)
    }
}
impl From<PacketServerScriptDebugDrawer> for McpePacket {
    fn from(packet: PacketServerScriptDebugDrawer) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketServerboundPackSettingChange {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketServerboundPackSettingChange;
}
impl From<PacketServerboundPackSettingChange> for McpePacketData {
    fn from(packet: PacketServerboundPackSettingChange) -> Self {
        McpePacketData::PacketServerboundPackSettingChange(Box::new(packet))
    }
}
impl From<PacketServerboundPackSettingChange> for McpePacket {
    fn from(packet: PacketServerboundPackSettingChange) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketClientboundDataStore {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketClientboundDataStore;
}
impl From<PacketClientboundDataStore> for McpePacketData {
    fn from(packet: PacketClientboundDataStore) -> Self {
        McpePacketData::PacketClientboundDataStore(packet)
    }
}
impl From<PacketClientboundDataStore> for McpePacket {
    fn from(packet: PacketClientboundDataStore) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketGraphicsOverrideParameter {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketGraphicsOverrideParameter;
}
impl From<PacketGraphicsOverrideParameter> for McpePacketData {
    fn from(packet: PacketGraphicsOverrideParameter) -> Self {
        McpePacketData::PacketGraphicsOverrideParameter(Box::new(packet))
    }
}
impl From<PacketGraphicsOverrideParameter> for McpePacket {
    fn from(packet: PacketGraphicsOverrideParameter) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
impl GamePacket for PacketServerboundDataStore {
    type PacketId = McpePacketName;
    const PACKET_ID: McpePacketName = McpePacketName::PacketServerboundDataStore;
}
impl From<PacketServerboundDataStore> for McpePacketData {
    fn from(packet: PacketServerboundDataStore) -> Self {
        McpePacketData::PacketServerboundDataStore(Box::new(packet))
    }
}
impl From<PacketServerboundDataStore> for McpePacket {
    fn from(packet: PacketServerboundDataStore) -> Self {
        McpePacket::from(McpePacketData::from(packet))
    }
}
...
pub enum McpePacketData {
    ...
    PacketDisconnect(Box<PacketDisconnect>),
    ...
    PacketServerPostMove(PacketServerPostMove),
    ...
    PacketInventoryContent(Box<PacketInventoryContent>),
    ...
    PacketChangeDimension(Box<PacketChangeDimension>),
    ...
    PacketLecternUpdate(PacketLecternUpdate),
    ...
    PacketPlayerArmorDamage(PacketPlayerArmorDamage),
    ...
    PacketItemRegistry(PacketItemRegistry),
    ...
    PacketUpdateClientInputLocks(PacketUpdateClientInputLocks),
    PacketClientCheatAbility(Box<PacketClientCheatAbility>),
    PacketCameraPresets(PacketCameraPresets),
    PacketUnlockedRecipes(PacketUnlockedRecipes),
    PacketCameraInstruction(Box<PacketCameraInstruction>),
    PacketCompressedBiomeDefinitions(PacketCompressedBiomeDefinitions),
    PacketTrimData(PacketTrimData),
    PacketOpenSign(PacketOpenSign),
    PacketAgentAnimation(PacketAgentAnimation),
    PacketRefreshEntitlements(PacketRefreshEntitlements),
    PacketToggleCrafterSlotRequest(PacketToggleCrafterSlotRequest),
    PacketSetPlayerInventoryOptions(Box<PacketSetPlayerInventoryOptions>),
    PacketSetHud(PacketSetHud),
    PacketAwardAchievement(PacketAwardAchievement),
    PacketClientboundCloseForm(PacketClientboundCloseForm),
    PacketServerboundLoadingScreen(PacketServerboundLoadingScreen),
    PacketJigsawStructureData(PacketJigsawStructureData),
    PacketCurrentStructureFeature(PacketCurrentStructureFeature),
    PacketServerboundDiagnostics(Box<PacketServerboundDiagnostics>),
    PacketCameraAimAssist(Box<PacketCameraAimAssist>),
    PacketContainerRegistryCleanup(PacketContainerRegistryCleanup),
    PacketMovementEffect(Box<PacketMovementEffect>),
    PacketSetMovementAuthority(PacketSetMovementAuthority),
    PacketCameraAimAssistPresets(PacketCameraAimAssistPresets),
    PacketClientCameraAimAssist(PacketClientCameraAimAssist),
    PacketClientMovementPredictionSync(Box<PacketClientMovementPredictionSync>),
    PacketUpdateClientOptions(PacketUpdateClientOptions),
    PacketPlayerVideoCapture(Box<PacketPlayerVideoCapture>),
    PacketPlayerUpdateEntityOverrides(Box<PacketPlayerUpdateEntityOverrides>),
    PacketPlayerLocation(Box<PacketPlayerLocation>),
    PacketClientboundControlsScheme(PacketClientboundControlsScheme),
    PacketServerScriptDebugDrawer(PacketServerScriptDebugDrawer),
    PacketServerboundPackSettingChange(Box<PacketServerboundPackSettingChange>),
    PacketClientboundDataStore(PacketClientboundDataStore),
    PacketGraphicsOverrideParameter(Box<PacketGraphicsOverrideParameter>),
    PacketServerboundDataStore(Box<PacketServerboundDataStore>),
}
impl McpePacketData {
        ...
        let packet = match packet_id {
            ...
            McpePacketName::PacketItemRegistry => {
                let packet = McpePacketData::PacketItemRegistry(
                    <PacketItemRegistry as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketAwardAchievement => {
                let packet = McpePacketData::PacketAwardAchievement(
                    <PacketAwardAchievement as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketClientboundCloseForm => {
                let packet = McpePacketData::PacketClientboundCloseForm(
                    <PacketClientboundCloseForm as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketServerboundLoadingScreen => {
                let packet = McpePacketData::PacketServerboundLoadingScreen(
                    <PacketServerboundLoadingScreen as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketJigsawStructureData => {
                let packet = McpePacketData::PacketJigsawStructureData(
                    <PacketJigsawStructureData as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketCurrentStructureFeature => {
                let packet = McpePacketData::PacketCurrentStructureFeature(
                    <PacketCurrentStructureFeature as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketServerboundDiagnostics => {
                let packet = McpePacketData::PacketServerboundDiagnostics(
                    Box::new(
                        <PacketServerboundDiagnostics as crate::bedrock::codec::BedrockCodec>::decode(
                            &mut payload_buf,
                            (),
                        )?,
                    ),
            ...
            McpePacketName::PacketCameraAimAssist => {
                let packet = McpePacketData::PacketCameraAimAssist(
                    Box::new(
                        <PacketCameraAimAssist as crate::bedrock::codec::BedrockCodec>::decode(
                            &mut payload_buf,
                            (),
                        )?,
                    ),
            ...
            McpePacketName::PacketContainerRegistryCleanup => {
                let packet = McpePacketData::PacketContainerRegistryCleanup(
                    <PacketContainerRegistryCleanup as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketMovementEffect => {
                let packet = McpePacketData::PacketMovementEffect(
                    Box::new(
                        <PacketMovementEffect as crate::bedrock::codec::BedrockCodec>::decode(
                            &mut payload_buf,
                            (),
                        )?,
                    ),
            ...
            McpePacketName::PacketSetMovementAuthority => {
                let packet = McpePacketData::PacketSetMovementAuthority(
                    <PacketSetMovementAuthority as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketCameraAimAssistPresets => {
                let packet = McpePacketData::PacketCameraAimAssistPresets(
                    <PacketCameraAimAssistPresets as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketClientCameraAimAssist => {
                let packet = McpePacketData::PacketClientCameraAimAssist(
                    <PacketClientCameraAimAssist as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketClientMovementPredictionSync => {
                let packet = McpePacketData::PacketClientMovementPredictionSync(
                    Box::new(
                        <PacketClientMovementPredictionSync as crate::bedrock::codec::BedrockCodec>::decode(
                            &mut payload_buf,
                            (),
                        )?,
                    ),
            ...
            McpePacketName::PacketUpdateClientOptions => {
                let packet = McpePacketData::PacketUpdateClientOptions(
                    <PacketUpdateClientOptions as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketPlayerVideoCapture => {
                let packet = McpePacketData::PacketPlayerVideoCapture(
                    Box::new(
                        <PacketPlayerVideoCapture as crate::bedrock::codec::BedrockCodec>::decode(
                            &mut payload_buf,
                            (),
                        )?,
                    ),
            ...
            McpePacketName::PacketPlayerUpdateEntityOverrides => {
                let packet = McpePacketData::PacketPlayerUpdateEntityOverrides(
                    Box::new(
                        <PacketPlayerUpdateEntityOverrides as crate::bedrock::codec::BedrockCodec>::decode(
                            &mut payload_buf,
                            (),
                        )?,
                    ),
            ...
            McpePacketName::PacketPlayerLocation => {
                let packet = McpePacketData::PacketPlayerLocation(
                    Box::new(
                        <PacketPlayerLocation as crate::bedrock::codec::BedrockCodec>::decode(
                            &mut payload_buf,
                            (),
                        )?,
                    ),
            ...
            McpePacketName::PacketClientboundControlsScheme => {
                let packet = McpePacketData::PacketClientboundControlsScheme(
                    <PacketClientboundControlsScheme as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketServerScriptDebugDrawer => {
                let packet = McpePacketData::PacketServerScriptDebugDrawer(
                    <PacketServerScriptDebugDrawer as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketServerboundPackSettingChange => {
                let packet = McpePacketData::PacketServerboundPackSettingChange(
                    Box::new(
                        <PacketServerboundPackSettingChange as crate::bedrock::codec::BedrockCodec>::decode(
                            &mut payload_buf,
                            (),
                        )?,
                    ),
            ...
            McpePacketName::PacketClientboundDataStore => {
                let packet = McpePacketData::PacketClientboundDataStore(
                    <PacketClientboundDataStore as crate::bedrock::codec::BedrockCodec>::decode(
                        &mut payload_buf,
                        (),
                    )?,
                );
            ...
            McpePacketName::PacketGraphicsOverrideParameter => {
                let packet = McpePacketData::PacketGraphicsOverrideParameter(
                    Box::new(
                        <PacketGraphicsOverrideParameter as crate::bedrock::codec::BedrockCodec>::decode(
                            &mut payload_buf,
                            (),
                        )?,
                    ),
            ...
            McpePacketName::PacketServerboundDataStore => {
                let packet = McpePacketData::PacketServerboundDataStore(
                    Box::new(
                        <PacketServerboundDataStore as crate::bedrock::codec::BedrockCodec>::decode(
                            &mut payload_buf,
                            (),
                        )?,
                    ),
