...
pub enum SoundType {
    ...
    MaceSmashAir = 516,
    MaceSmashGround = 517,
    TrailSpawnerChargeActivate = 518,
    TrailSpawnerAmbientOminous = 519,
    OminousItemSpawnerSpawnItem = 520,
    OminousBottleEndUse = 521,
    MaceSmashHeavyGround = 522,
    OminousItemSpawnerSpawnItemBegin = 523,
    Unknown524 = 524,
    ApplyEffectBadOmen = 525,
    ApplyEffectRaidOmen = 526,
    ApplyEffectTrialOmen = 527,
    OminousItemSpawnerAboutToSpawnItem = 528,
    RecordCreator = 529,
    RecordCreatorMusicBox = 530,
    RecordPrecipice = 531,
}
impl crate::bedrock::codec::BedrockCodec for SoundType {
    ...
    fn decode<B: bytes::Buf>(
        ...
        match val {
            ...
            511 => Ok(SoundType::BundleInsertFailed),
            512 => Ok(SoundType::Unknown),
            513 => Ok(SoundType::ArmorCrackWolf),
            514 => Ok(SoundType::ArmorBreakWolf),
            515 => Ok(SoundType::ArmorRepairWolf),
            516 => Ok(SoundType::MaceSmashAir),
            517 => Ok(SoundType::MaceSmashGround),
            518 => Ok(SoundType::TrailSpawnerChargeActivate),
            519 => Ok(SoundType::TrailSpawnerAmbientOminous),
            520 => Ok(SoundType::OminousItemSpawnerSpawnItem),
            521 => Ok(SoundType::OminousBottleEndUse),
            522 => Ok(SoundType::MaceSmashHeavyGround),
            523 => Ok(SoundType::OminousItemSpawnerSpawnItemBegin),
            524 => Ok(SoundType::Unknown),
            525 => Ok(SoundType::ApplyEffectBadOmen),
            526 => Ok(SoundType::ApplyEffectRaidOmen),
            527 => Ok(SoundType::ApplyEffectTrialOmen),
            528 => Ok(SoundType::OminousItemSpawnerAboutToSpawnItem),
            529 => Ok(SoundType::RecordCreator),
            530 => Ok(SoundType::RecordCreatorMusicBox),
            531 => Ok(SoundType::RecordPrecipice),
            _ => {
                Err(
                    std::io::Error::new(
                        std::io::ErrorKind::InvalidData,
