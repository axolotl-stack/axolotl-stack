...
bitflags! {
    ...
    const ITEM_STACK_REQUEST = 68719476736; }
}
...
impl crate::bedrock::codec::BedrockCodec for MaterialReducerItems {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::VarInt(self.count as i32).encode(buf)?;
        Ok(())
    }
    fn decode<B: bytes::Buf>(
        buf: &mut B,
...
impl crate::bedrock::codec::BedrockCodec for MaterialReducer {
    type Args = ();
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        crate::bedrock::codec::VarInt(self.mix as i32).encode(buf)?;
...
impl crate::bedrock::codec::BedrockCodec for RecipeIngredientContent {
    type Args = ();
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        crate::bedrock::codec::ZigZag32(self.network_data as i32).encode(buf)?;
...
impl crate::bedrock::codec::BedrockCodec for SoundType {
    ...
    fn decode<B: bytes::Buf>(
        ...
        match val {
            ...
            335 => Ok(SoundType::Unknown335),
            336 => Ok(SoundType::Unknown336),
            337 => Ok(SoundType::Unknown337),
            338 => Ok(SoundType::Unknown338),
            ...
            360 => Ok(SoundType::ExtinguishCandle),
            361 => Ok(SoundType::AmbientCandle),
            362 => Ok(SoundType::Undefined),
            _ => {
                Err(
                    std::io::Error::new(
                        std::io::ErrorKind::InvalidData,
...
pub enum McpePacketParams {
    ...
    AddVolumeEntity(PacketAddVolumeEntity),
    ...
    SubchunkRequest(Box<PacketSubchunkRequest>),
