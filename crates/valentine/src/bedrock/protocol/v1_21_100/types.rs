...
impl crate::bedrock::codec::BedrockCodec for BiomeCoordinate {
    type Args = ();
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        crate::bedrock::codec::ZigZag32(self.min_value_type as i32).encode(buf)?;
        self.min_value.encode(buf)?;
        crate::bedrock::codec::ZigZag32(self.max_value_type as i32).encode(buf)?;
...
impl crate::bedrock::codec::BedrockCodec for BiomeScatterParameter {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::ZigZag32(self.chance_percent_type as i32).encode(buf)?;
        self.chance_percent.encode(buf)?;
        self.chance_numerator.encode(buf)?;
        self.chance_denominator.encode(buf)?;
        crate::bedrock::codec::ZigZag32(self.iterations_type as i32).encode(buf)?;
...
impl crate::bedrock::codec::BedrockCodec for BiomeElementData {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::ZigZag32(self.height_min_type as i32).encode(buf)?;
        self.height_min.encode(buf)?;
        crate::bedrock::codec::ZigZag32(self.height_max_type as i32).encode(buf)?;
...
impl crate::bedrock::codec::BedrockCodec for BiomeTemperatureWeight {
    type Args = ();
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        crate::bedrock::codec::ZigZag32(self.temperature as i32).encode(buf)?;
        self.weight.encode(buf)?;
        Ok(())
    }
    fn decode<B: bytes::Buf>(
...
pub enum SoundType {
    ...
    MaceSmashAir = 544,
    MaceSmashGround = 545,
    TrailSpawnerChargeActivate = 546,
    TrailSpawnerAmbientOminous = 547,
    OminousItemSpawnerSpawnItem = 548,
    OminousBottleEndUse = 549,
    MaceSmashHeavyGround = 550,
    OminousItemSpawnerSpawnItemBegin = 551,
    Unknown552 = 552,
    ApplyEffectBadOmen = 553,
    ApplyEffectRaidOmen = 554,
    ApplyEffectTrialOmen = 555,
    OminousItemSpawnerAboutToSpawnItem = 556,
    RecordCreator = 557,
    RecordCreatorMusicBox = 558,
    RecordPrecipice = 559,
}
impl crate::bedrock::codec::BedrockCodec for SoundType {
    ...
    fn decode<B: bytes::Buf>(
        ...
        match val {
            ...
            540 => Ok(SoundType::EquipCopper),
            541 => Ok(SoundType::ArmorCrackWolf),
            542 => Ok(SoundType::ArmorBreakWolf),
            543 => Ok(SoundType::ArmorRepairWolf),
            544 => Ok(SoundType::MaceSmashAir),
            545 => Ok(SoundType::MaceSmashGround),
            546 => Ok(SoundType::TrailSpawnerChargeActivate),
            547 => Ok(SoundType::TrailSpawnerAmbientOminous),
            548 => Ok(SoundType::OminousItemSpawnerSpawnItem),
            549 => Ok(SoundType::OminousBottleEndUse),
            550 => Ok(SoundType::MaceSmashHeavyGround),
            551 => Ok(SoundType::OminousItemSpawnerSpawnItemBegin),
            552 => Ok(SoundType::Unknown),
            553 => Ok(SoundType::ApplyEffectBadOmen),
            554 => Ok(SoundType::ApplyEffectRaidOmen),
            555 => Ok(SoundType::ApplyEffectTrialOmen),
            556 => Ok(SoundType::OminousItemSpawnerAboutToSpawnItem),
            557 => Ok(SoundType::RecordCreator),
            558 => Ok(SoundType::RecordCreatorMusicBox),
            559 => Ok(SoundType::RecordPrecipice),
            _ => {
                Err(
                    std::io::Error::new(
                        std::io::ErrorKind::InvalidData,
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        if let Some(v) = &self.params {
            match v {
                ...
                McpePacketParams::AwardAchievement(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::CameraAimAssist(v) => {
                    (&**v).encode(buf)?;
                }
                McpePacketParams::CameraAimAssistPresets(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::ClientCameraAimAssist(v) => {
                    v.encode(buf)?;
                }
                McpePacketParams::ClientCheatAbility(v) => {
                    (&**v).encode(buf)?;
                }
                McpePacketParams::ClientMovementPredictionSync(v) => {
                    (&**v).encode(buf)?;
                }
                ...
                McpePacketParams::ClientboundCloseForm(v) => {
                    v.encode(buf)?;
                }
                McpePacketParams::ClientboundControlsScheme(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::ContainerRegistryCleanup(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::CurrentStructureFeature(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::ItemRegistry(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::JigsawStructureData(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::MovementEffect(v) => {
                    (&**v).encode(buf)?;
                }
                ...
                McpePacketParams::PlayerLocation(v) => {
                    (&**v).encode(buf)?;
                }
                McpePacketParams::PlayerSkin(v) => {
                    (&**v).encode(buf)?;
                }
                McpePacketParams::PlayerUpdateEntityOverrides(v) => {
                    (&**v).encode(buf)?;
                }
                McpePacketParams::PlayerVideoCapture(v) => {
                    (&**v).encode(buf)?;
                }
                ...
                McpePacketParams::RefreshEntitlements(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::ServerPostMove(v) => {
                    v.encode(buf)?;
                }
                McpePacketParams::ServerScriptDebugDrawer(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::ServerboundDiagnostics(v) => {
                    (&**v).encode(buf)?;
                }
                McpePacketParams::ServerboundLoadingScreen(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::SetMovementAuthority(v) => {
                    v.encode(buf)?;
                }
                McpePacketParams::SetPlayerGameType(v) => {
                    v.encode(buf)?;
                }
                McpePacketParams::SetPlayerInventoryOptions(v) => {
                    (&**v).encode(buf)?;
                }
                ...
                McpePacketParams::ToggleCrafterSlotRequest(v) => {
                    v.encode(buf)?;
                }
                ...
                McpePacketParams::UpdateClientOptions(v) => {
                    v.encode(buf)?;
                }
