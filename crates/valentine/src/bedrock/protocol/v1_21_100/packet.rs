...
impl crate::bedrock::codec::BedrockCodec for McpePacketName {
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        match val {
            ...
            162 => Ok(McpePacketName::ItemRegistry),
            ...
            309 => Ok(McpePacketName::AwardAchievement),
            310 => Ok(McpePacketName::ClientboundCloseForm),
            312 => Ok(McpePacketName::ServerboundLoadingScreen),
            313 => Ok(McpePacketName::JigsawStructureData),
            314 => Ok(McpePacketName::CurrentStructureFeature),
            315 => Ok(McpePacketName::ServerboundDiagnostics),
            316 => Ok(McpePacketName::CameraAimAssist),
            317 => Ok(McpePacketName::ContainerRegistryCleanup),
            318 => Ok(McpePacketName::MovementEffect),
            319 => Ok(McpePacketName::SetMovementAuthority),
            320 => Ok(McpePacketName::CameraAimAssistPresets),
            321 => Ok(McpePacketName::ClientCameraAimAssist),
            322 => Ok(McpePacketName::ClientMovementPredictionSync),
            323 => Ok(McpePacketName::UpdateClientOptions),
            324 => Ok(McpePacketName::PlayerVideoCapture),
            325 => Ok(McpePacketName::PlayerUpdateEntityOverrides),
            326 => Ok(McpePacketName::PlayerLocation),
            327 => Ok(McpePacketName::ClientboundControlsScheme),
            328 => Ok(McpePacketName::ServerScriptDebugDrawer),
            _ => {
                Err(
                    std::io::Error::new(
...
impl crate::bedrock::codec::BedrockCodec for PacketBossEvent {
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        if let Some(v) = &self.content {
            match v {
                PacketBossEventContent::Query(v) => v.encode(buf)?,
...
impl crate::bedrock::codec::BedrockCodec for PacketEmote {
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        self.emote_length_ticks.encode(buf)?;
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        let emote_length_ticks = <i32 as crate::bedrock::codec::BedrockCodec>::decode(
            buf,
        )?;
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        let elements = {
            ...
            for _ in 0..len {
                tmp_vec
                    .push(
                        <Element as crate::bedrock::codec::BedrockCodec>::decode(buf)?,
                    );
            }
            tmp_vec
        };
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(u8)]
pub enum PacketUpdateClientOptionsGraphicsModeSome {
    Simple = 0,
    Fancy = 1,
    Advanced = 2,
    RayTraced = 3,
}
impl crate::bedrock::codec::BedrockCodec for PacketUpdateClientOptionsGraphicsModeSome {
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        let val = *self as u8;
        val.encode(buf)
    }
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        let val = <u8 as crate::bedrock::codec::BedrockCodec>::decode(buf)?;
        match val {
            0 => Ok(PacketUpdateClientOptionsGraphicsModeSome::Simple),
            1 => Ok(PacketUpdateClientOptionsGraphicsModeSome::Fancy),
            2 => Ok(PacketUpdateClientOptionsGraphicsModeSome::Advanced),
            3 => Ok(PacketUpdateClientOptionsGraphicsModeSome::RayTraced),
            _ => {
                Err(
                    std::io::Error::new(
                        std::io::ErrorKind::InvalidData,
                        format!(
                            "Invalid enum value for {}: {}",
                            stringify!(PacketUpdateClientOptionsGraphicsModeSome), val
                        ),
                    ),
                )
            }
...
pub struct PacketUpdateClientOptions {
    pub graphics_mode: Option<PacketUpdateClientOptionsGraphicsModeSome>,
}
impl crate::bedrock::codec::BedrockCodec for PacketUpdateClientOptions {
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        let graphics_mode = {
            ...
            if present != 0 {
                Some(
                    <PacketUpdateClientOptionsGraphicsModeSome as crate::bedrock::codec::BedrockCodec>::decode(
                        buf,
                    )?,
                )
            } else {
...
pub enum McpePacketParams {
    ...
    AwardAchievement(PacketAwardAchievement),
    ...
    Camera(PacketCamera),
    CameraAimAssist(Box<PacketCameraAimAssist>),
    CameraAimAssistPresets(PacketCameraAimAssistPresets),
    CameraInstruction(Box<PacketCameraInstruction>),
    CameraPresets(PacketCameraPresets),
    CameraShake(Box<PacketCameraShake>),
    ChangeDimension(Box<PacketChangeDimension>),
    ...
    ClientCameraAimAssist(PacketClientCameraAimAssist),
    ClientCheatAbility(Box<PacketClientCheatAbility>),
    ClientMovementPredictionSync(Box<PacketClientMovementPredictionSync>),
    ClientStartItemCooldown(PacketClientStartItemCooldown),
    ClientToServerHandshake(PacketClientToServerHandshake),
    ClientboundCloseForm(PacketClientboundCloseForm),
    ClientboundControlsScheme(PacketClientboundControlsScheme),
    ...
    ContainerRegistryCleanup(PacketContainerRegistryCleanup),
    ...
    MovementEffect(Box<PacketMovementEffect>),
    ...
    PlayerLocation(Box<PacketPlayerLocation>),
    PlayerSkin(Box<PacketPlayerSkin>),
    PlayerUpdateEntityOverrides(Box<PacketPlayerUpdateEntityOverrides>),
    PlayerVideoCapture(Box<PacketPlayerVideoCapture>),
    ...
    ServerScriptDebugDrawer(PacketServerScriptDebugDrawer),
    ...
    ServerboundDiagnostics(Box<PacketServerboundDiagnostics>),
    ServerboundLoadingScreen(PacketServerboundLoadingScreen),
    ...
    SetMovementAuthority(PacketSetMovementAuthority),
    ...
    UpdateClientOptions(PacketUpdateClientOptions),
...
impl crate::bedrock::codec::BedrockCodec for McpePacket {
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        if let Some(v) = &self.params {
            match v {
                ...
                McpePacketParams::AwardAchievement(v) => v.encode(buf)?,
                ...
                McpePacketParams::CameraAimAssist(v) => v.encode(buf)?,
                McpePacketParams::CameraAimAssistPresets(v) => v.encode(buf)?,
                ...
                McpePacketParams::ClientCameraAimAssist(v) => v.encode(buf)?,
                McpePacketParams::ClientCheatAbility(v) => v.encode(buf)?,
                McpePacketParams::ClientMovementPredictionSync(v) => v.encode(buf)?,
                McpePacketParams::ClientStartItemCooldown(v) => v.encode(buf)?,
                McpePacketParams::ClientToServerHandshake(v) => v.encode(buf)?,
                McpePacketParams::ClientboundCloseForm(v) => v.encode(buf)?,
                McpePacketParams::ClientboundControlsScheme(v) => v.encode(buf)?,
                ...
                McpePacketParams::ContainerRegistryCleanup(v) => v.encode(buf)?,
                ...
                McpePacketParams::CurrentStructureFeature(v) => v.encode(buf)?,
                ...
                McpePacketParams::MovementEffect(v) => v.encode(buf)?,
                ...
                McpePacketParams::PlayerLocation(v) => v.encode(buf)?,
                McpePacketParams::PlayerSkin(v) => v.encode(buf)?,
                McpePacketParams::PlayerUpdateEntityOverrides(v) => v.encode(buf)?,
                McpePacketParams::PlayerVideoCapture(v) => v.encode(buf)?,
                ...
                McpePacketParams::ServerScriptDebugDrawer(v) => v.encode(buf)?,
                ...
                McpePacketParams::ServerboundDiagnostics(v) => v.encode(buf)?,
                McpePacketParams::ServerboundLoadingScreen(v) => v.encode(buf)?,
                ...
                McpePacketParams::SetMovementAuthority(v) => v.encode(buf)?,
                ...
                McpePacketParams::UpdateClientOptions(v) => v.encode(buf)?,
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        let params = match name {
            ...
            McpePacketName::AwardAchievement => {
                Some(
                    McpePacketParams::AwardAchievement(
            ...
            McpePacketName::CameraAimAssist => {
                Some(
                    McpePacketParams::CameraAimAssist(
                        Box::new(
            ...
            McpePacketName::CameraAimAssistPresets => {
                Some(
                    McpePacketParams::CameraAimAssistPresets(
            ...
            McpePacketName::ClientCameraAimAssist => {
                Some(
                    McpePacketParams::ClientCameraAimAssist(
            ...
            McpePacketName::ClientMovementPredictionSync => {
                Some(
                    McpePacketParams::ClientMovementPredictionSync(
                        Box::new(
            ...
            McpePacketName::ClientboundCloseForm => {
                Some(
                    McpePacketParams::ClientboundCloseForm(
            ...
            McpePacketName::ClientboundControlsScheme => {
                Some(
                    McpePacketParams::ClientboundControlsScheme(
            ...
            McpePacketName::ContainerRegistryCleanup => {
                Some(
                    McpePacketParams::ContainerRegistryCleanup(
            ...
            McpePacketName::CurrentStructureFeature => {
                Some(
                    McpePacketParams::CurrentStructureFeature(
            ...
            McpePacketName::ItemRegistry => {
                Some(
                    McpePacketParams::ItemRegistry(
            ...
            McpePacketName::JigsawStructureData => {
                Some(
                    McpePacketParams::JigsawStructureData(
            ...
            McpePacketName::MovementEffect => {
                Some(
                    McpePacketParams::MovementEffect(
                        Box::new(
            ...
            McpePacketName::PlayerLocation => {
                Some(
                    McpePacketParams::PlayerLocation(
                        Box::new(
            ...
            McpePacketName::PlayerUpdateEntityOverrides => {
                Some(
                    McpePacketParams::PlayerUpdateEntityOverrides(
                        Box::new(
            ...
            McpePacketName::PlayerVideoCapture => {
                Some(
                    McpePacketParams::PlayerVideoCapture(
                        Box::new(
            ...
            McpePacketName::RefreshEntitlements => {
                Some(
            ...
            McpePacketName::ServerScriptDebugDrawer => {
                Some(
                    McpePacketParams::ServerScriptDebugDrawer(
            ...
            McpePacketName::ServerboundDiagnostics => {
                Some(
                    McpePacketParams::ServerboundDiagnostics(
                        Box::new(
            ...
            McpePacketName::ServerboundLoadingScreen => {
                Some(
                    McpePacketParams::ServerboundLoadingScreen(
            ...
            McpePacketName::SetMovementAuthority => {
                Some(
                    McpePacketParams::SetMovementAuthority(
            ...
            McpePacketName::SetPlayerInventoryOptions => {
                Some(
            ...
            McpePacketName::ToggleCrafterSlotRequest => {
                Some(
            ...
            McpePacketName::UpdateClientOptions => {
                Some(
                    McpePacketParams::UpdateClientOptions(
