...
impl crate::bedrock::codec::BedrockCodec for PacketNpcDialogue {
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        let screen_name = <String as crate::bedrock::codec::BedrockCodec>::decode(buf)?;
        let npc_name = <String as crate::bedrock::codec::BedrockCodec>::decode(buf)?;
        let action_json = <String as crate::bedrock::codec::BedrockCodec>::decode(buf)?;
        Ok(Self {
            entity_id,
            action_type,
            dialogue,
...
impl crate::bedrock::codec::BedrockCodec for PacketNpcRequest {
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        let scene_name = <String as crate::bedrock::codec::BedrockCodec>::decode(buf)?;
        Ok(Self {
            runtime_entity_id,
            request_type,
            command,
