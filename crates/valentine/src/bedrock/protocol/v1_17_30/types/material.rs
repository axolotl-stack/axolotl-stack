...
impl crate::bedrock::codec::BedrockCodec for MaterialReducerItems {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::VarInt(self.count).encode(buf)?;
        Ok(())
    }
    fn decode<B: bytes::Buf>(
        ...
        let network_id = <crate::bedrock::codec::VarInt as crate::bedrock::codec::BedrockCodec>::decode(
            ...
            .0;
        let count = <crate::bedrock::codec::VarInt as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0;
...
impl crate::bedrock::codec::BedrockCodec for MaterialReducer {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        let _ = buf;
        crate::bedrock::codec::VarInt(self.mix).encode(buf)?;
    ...
    fn decode<B: bytes::Buf>(
        ...
        let _ = buf;
        let mix = <crate::bedrock::codec::VarInt as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0;
