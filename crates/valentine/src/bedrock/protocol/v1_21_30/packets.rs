...
impl crate::bedrock::codec::BedrockCodec for PacketInventoryContent {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::VarInt(self.dynamic_container_size as i32).encode(buf)?;
        Ok(())
    }
    fn decode<B: bytes::Buf>(
        buf: &mut B,
        ...
        let dynamic_container_size = <crate::bedrock::codec::ZigZag32 as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0 as i32;
...
impl crate::bedrock::codec::BedrockCodec for PacketUpdatePlayerGameType {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        self.gamemode.encode(buf)?;
        crate::bedrock::codec::ZigZag64(self.player_unique_id as i64).encode(buf)?;
        crate::bedrock::codec::VarInt(self.tick as i32).encode(buf)?;
        Ok(())
    }
    fn decode<B: bytes::Buf>(
        buf: &mut B,
        ...
        let player_unique_id = <crate::bedrock::codec::ZigZag64 as crate::bedrock::codec::BedrockCodec>::decode(
            ...
            .0 as i64;
        let tick = <crate::bedrock::codec::ZigZag32 as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0 as i32;
