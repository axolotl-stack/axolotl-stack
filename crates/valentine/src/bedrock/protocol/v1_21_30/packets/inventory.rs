...
impl crate::bedrock::codec::BedrockCodec for PacketInventoryContent {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::VarInt(self.dynamic_container_size).encode(buf)?;
        Ok(())
    }
    fn decode<B: bytes::Buf>(
        ...
        let dynamic_container_size = <crate::bedrock::codec::VarInt as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0;
