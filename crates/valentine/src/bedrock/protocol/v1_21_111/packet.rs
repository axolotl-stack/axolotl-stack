...
impl crate::bedrock::codec::BedrockCodec for McpePacketName {
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        match val {
            ...
            329 => Ok(McpePacketName::ServerboundPackSettingChange),
            _ => {
                Err(
                    std::io::Error::new(
...
pub enum McpePacketParams {
    ...
    PlayerArmorDamage(PacketPlayerArmorDamage),
    ...
    ServerboundPackSettingChange(Box<PacketServerboundPackSettingChange>),
...
impl crate::bedrock::codec::BedrockCodec for McpePacket {
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        if let Some(v) = &self.params {
            match v {
                ...
                McpePacketParams::ServerboundPackSettingChange(v) => v.encode(buf)?,
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        let params = match name {
            ...
            McpePacketName::ServerboundPackSettingChange => {
                Some(
                    McpePacketParams::ServerboundPackSettingChange(
                        Box::new(
