...
impl crate::bedrock::codec::BedrockCodec for PacketCommandRequest {
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        let version = <i32 as crate::bedrock::codec::BedrockCodec>::decode(buf)?;
        Ok(Self {
            command,
            origin,
            internal,
...
impl crate::bedrock::codec::BedrockCodec for PacketStartGame {
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        let editor_world = <bool as crate::bedrock::codec::BedrockCodec>::decode(buf)?;
