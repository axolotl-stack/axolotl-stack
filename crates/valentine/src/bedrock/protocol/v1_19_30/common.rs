...
impl crate::bedrock::codec::BedrockCodec for RecipeIngredientContentIntIDMeta {
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        ...
        let metadata = match network_id {
            0 => None,
            _ => Some(<i16 as crate::bedrock::codec::BedrockCodec>::decode(buf)?),
        };
        Ok(Self { metadata })
    }
}
...
impl crate::bedrock::codec::BedrockCodec for RecipeIngredientContentMolang {
    ...
    fn decode<B: bytes::Buf>(buf: &mut B) -> Result<Self, std::io::Error> {
        let expression = <String as crate::bedrock::codec::BedrockCodec>::decode(buf)?;
