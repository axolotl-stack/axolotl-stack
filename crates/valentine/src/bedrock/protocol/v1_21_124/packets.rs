...
impl crate::bedrock::codec::BedrockCodec for PacketClientMovementPredictionSync {
    type Args = ();
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        crate::bedrock::codec::VarLong(self.data_flags as i64).encode(buf)?;
    ...
    fn decode<B: bytes::Buf>(
        ...
        let data_flags = <crate::bedrock::codec::ZigZag64 as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0 as i64;
...
impl crate::bedrock::codec::BedrockCodec for PacketCreativeContentItemsItem {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        self.item.encode(buf)?;
        crate::bedrock::codec::VarInt(self.group_index as i32).encode(buf)?;
        Ok(())
    }
    fn decode<B: bytes::Buf>(
        buf: &mut B,
        ...
        let group_index = <crate::bedrock::codec::ZigZag32 as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0 as i32;
...
impl crate::bedrock::codec::BedrockCodec for PacketEmote {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::VarInt(self.emote_length_ticks as i32).encode(buf)?;
        self.xuid.encode(buf)?;
    ...
    fn decode<B: bytes::Buf>(
        ...
        let emote_length_ticks = <crate::bedrock::codec::ZigZag32 as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0 as i32;
...
impl crate::bedrock::codec::BedrockCodec for PacketLevelEventEvent {
    ...
    fn decode<B: bytes::Buf>(
        ...
        match val {
            ...
            3616 => Ok(PacketLevelEventEvent::OminousItemSpawner),
            3617 => Ok(PacketLevelEventEvent::CreakingCrumble),
            3618 => Ok(PacketLevelEventEvent::PaleOakLeaves),
            3619 => Ok(PacketLevelEventEvent::EyeblossomOpen),
            3620 => Ok(PacketLevelEventEvent::EyeblossomClose),
            3621 => Ok(PacketLevelEventEvent::GreenFlame),
...
impl crate::bedrock::codec::BedrockCodec for PacketMovementEffect {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::VarInt(self.effect_duration as i32).encode(buf)?;
        crate::bedrock::codec::VarLong(self.tick as i64).encode(buf)?;
        Ok(())
    }
    fn decode<B: bytes::Buf>(
...
impl crate::bedrock::codec::BedrockCodec for PacketPlayerAuthInputContent {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::ZigZag64(self.predicted_vehicle as i64).encode(buf)?;
        Ok(())
    }
    fn decode<B: bytes::Buf>(
        buf: &mut B,
...
impl crate::bedrock::codec::BedrockCodec for PacketPlayerUpdateEntityOverrides {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        crate::bedrock::codec::VarLong(self.runtime_id as i64).encode(buf)?;
        crate::bedrock::codec::VarInt(self.property_index as i32).encode(buf)?;
        self.type_.encode(buf)?;
    ...
    fn decode<B: bytes::Buf>(
        ...
        let runtime_id = <crate::bedrock::codec::ZigZag64 as crate::bedrock::codec::BedrockCodec>::decode(
            ...
            .0 as i64;
        let property_index = <crate::bedrock::codec::ZigZag32 as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0 as i32;
...
impl crate::bedrock::codec::BedrockCodec for PacketServerboundLoadingScreen {
    type Args = ();
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        crate::bedrock::codec::ZigZag32(self.type_ as i32).encode(buf)?;
        match &self.loading_screen_id {
            Some(v) => {
                buf.put_u8(1);
                (*v).encode(buf)?;
