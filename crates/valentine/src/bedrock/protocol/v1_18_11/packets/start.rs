...
impl crate::bedrock::codec::BedrockCodec for PacketStartGame {
    ...
    fn encode<B: bytes::BufMut>(&self, buf: &mut B) -> Result<(), std::io::Error> {
        ...
        crate::bedrock::codec::VarInt(len as i32).encode(buf)?;
        buf.put_slice(&bytes);
        crate::bedrock::codec::U64LE(self.block_pallete_checksum).encode(buf)?;
        Ok(())
    }
    fn decode<B: bytes::Buf>(
        ...
        let block_pallete_checksum = <crate::bedrock::codec::U64LE as crate::bedrock::codec::BedrockCodec>::decode(
                buf,
                (),
            )?
            .0;
